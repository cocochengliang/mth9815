...
// Defines generic Service, ServiceListener, and Connector classes.
...
public:
  ...
  // Listener callback to process a remove event from the Service
  virtual void ProcessRemove(V &data) = 0;

  // Listener callback to process an update event on the Service
